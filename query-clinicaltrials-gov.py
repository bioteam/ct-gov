...
./query-clinicaltrials-gov.py --field EnrollmentCount --sponsors NCI NEI NHLBI NHGRI NIA NIAAA NIAID NIAMS NICHD NIDCD NIDCR NIDDK NIDA NIMH NINDS NINR NCCIH CC
...
parser.add_argument('--field', required=True, help="Field to count: EnrollmentCount or StudyType")
